...
The skill suite for the **CCVI family** of products (Claude Code via IDE): four
tightly-coupled Claude Code skills - `modes`, `plans`, `seedprompt`, and
`cleancode` - shipped as **one plugin with one version**.
...
Current version: ccvi-skills · v0.0.10
...
`ccvi-skills:seedprompt`, `ccvi-skills:cleancode`).
