...
```text
/cleancode · v0.0.19 — post-stabilization code consolidation. Run ONLY when a version is done, tested, and green — invoking a destructive verb IS the stabilization declaration:
